package com.svn.app.wlt.api.binance.impl;

import com.svn.app.wlt.api.binance.BinanceApiAsyncRestClient;
import com.svn.app.wlt.api.binance.BinanceApiCallback;
import com.svn.app.wlt.api.binance.config.BinanceApiConfig;
import com.svn.app.wlt.api.binance.constant.BinanceApiConstants;
import com.svn.app.wlt.api.binance.domain.account.Account;
import com.svn.app.wlt.api.binance.domain.account.DepositAddress;
import com.svn.app.wlt.api.binance.domain.account.DepositHistory;
import com.svn.app.wlt.api.binance.domain.account.NewOrder;
import com.svn.app.wlt.api.binance.domain.account.NewOrderResponse;
import com.svn.app.wlt.api.binance.domain.account.Order;
import com.svn.app.wlt.api.binance.domain.account.Trade;
import com.svn.app.wlt.api.binance.domain.account.TradeHistoryItem;
import com.svn.app.wlt.api.binance.domain.account.WithdrawHistory;
import com.svn.app.wlt.api.binance.domain.account.WithdrawResult;
import com.svn.app.wlt.api.binance.domain.account.request.AllOrdersRequest;
import com.svn.app.wlt.api.binance.domain.account.request.CancelOrderRequest;
import com.svn.app.wlt.api.binance.domain.account.request.CancelOrderResponse;
import com.svn.app.wlt.api.binance.domain.account.request.OrderRequest;
import com.svn.app.wlt.api.binance.domain.account.request.OrderStatusRequest;
import com.svn.app.wlt.api.binance.domain.event.ListenKey;
import com.svn.app.wlt.api.binance.domain.general.Asset;
import com.svn.app.wlt.api.binance.domain.general.ExchangeInfo;
import com.svn.app.wlt.api.binance.domain.general.ServerTime;
import com.svn.app.wlt.api.binance.domain.market.AggTrade;
import com.svn.app.wlt.api.binance.domain.market.BookTicker;
...
import com.svn.app.wlt.api.binance.domain.market.OrderBook;
import com.svn.app.wlt.api.binance.domain.market.TickerPrice;
import com.svn.app.wlt.api.binance.domain.market.TickerStatistics;

import java.util.List;

import static com.svn.app.wlt.api.binance.impl.BinanceApiServiceGenerator.createService;
